...
def train(model, g, args):
    ...
    path_saver = os.path.join(log.save_dir_path, f"{log.model}_best({str(args.seed).zfill(2)}).pkl")
    prob_saver = os.path.join(log.save_dir_path, f"probs_best({str(args.seed).zfill(2)}).pkl")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--seed", type=int, default=2, help="set the seed")
